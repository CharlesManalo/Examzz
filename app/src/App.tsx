...
import { initDatabase, getCurrentUser, setCurrentUser, trackActiveUser } from '@/services/database';
...
function App() {
  ...
  const handleRegister = (user: User) => {
    setCurrentUserState(user);
    setCurrentUser(user);
    toast.success('Account created!', { description: 'Welcome to StudyQuiz Pro' });
    navigateTo('dashboard');
  };
  ...
  const renderView = () => {
    ...
    switch (currentView) {
      ...
      case 'login':
        return currentUser ? 
          <Dashboard onNavigate={navigateTo} user={currentUser} onLogout={handleLogout} onStartQuiz={startQuiz} /> : 
      ...
      case 'upload':
        return currentUser ? 
          <Upload onNavigate={navigateTo} user={currentUser} onStartQuiz={startQuiz} /> : 
          <Login onNavigate={navigateTo} onLogin={handleLogin} />;
