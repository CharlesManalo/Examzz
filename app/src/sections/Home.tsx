  ...
  const features = [
    {
      ...
      description: 'Support for PDF, Word, PowerPoint, and Excel files. Drag and drop up to 15 files at once.'
    },
    {
      icon: Brain,
      title: 'Smart Quiz Generation',
      description: 'Our rule-based system automatically creates quizzes from your study materials.'
    },
    {
      icon: Trophy,
      title: 'Kahoot-Style Exams',
      description: 'Interactive exam interface with timers, progress bars, and instant feedback.'
    },
    {
      icon: Clock,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-lg text-muted-foreground max-w-xl">
                Upload your documents and automatically generate quizzes, mock exams, and lesson reviews. 
                Study smarter with our Kahoot-style exam interface.
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4">
                <Button 
                  size="lg"
                  onClick={() => onNavigate(isAuthenticated ? 'upload' : 'register')}
            ...
            <div className="relative">
              <div className="relative rounded-2xl border bg-white p-2 shadow-2xl">
                <div className="rounded-xl bg-gradient-to-br from-violet-100 to-indigo-100 p-6">
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-center text-muted-foreground">Generating quiz...</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg p-4 border">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium">10 Questions Ready</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              Our platform provides all the tools you need to transform your study materials into effective learning experiences.
            </p>
          </div>
          ...
          <div className="relative rounded-3xl bg-gradient-to-br from-violet-600 to-indigo-600 p-8 lg:p-16 overflow-hidden">
            ...
            <div className="relative text-center max-w-2xl mx-auto">
              <div className="inline-flex items-center gap-2 rounded-full bg-white/20 px-4 py-2 mb-6">
                ...
                <span className="text-sm font-medium text-white">Start Learning Today</span>
              </div>
              ...
              <p className="text-violet-100 text-lg mb-8">
                Join thousands of students who are already studying smarter with StudyQuiz Pro.
              </p>
